...
.. tab:: Node (Complete)
    ...
    .. code-block:: xml
        ...
        <properties>
          <javet.version>4.1.7</javet.version>
        </properties>
...
.. tab:: Express
    ...
    .. code-block:: kotlin
        ...
        implementation("com.caoccao.javet:javet:4.1.7") // Must-have
        implementation("com.caoccao.javet:javet-node-linux-arm64:4.1.7")
        implementation("com.caoccao.javet:javet-node-linux-arm64-i18n:4.1.7")
        implementation("com.caoccao.javet:javet-node-linux-x86_64:4.1.7")
        implementation("com.caoccao.javet:javet-node-linux-x86_64-i18n:4.1.7")
        implementation("com.caoccao.javet:javet-node-macos-arm64:4.1.7")
        implementation("com.caoccao.javet:javet-node-macos-arm64-i18n:4.1.7")
        implementation("com.caoccao.javet:javet-node-macos-x86_64:4.1.7")
        implementation("com.caoccao.javet:javet-node-macos-x86_64-i18n:4.1.7")
        implementation("com.caoccao.javet:javet-node-windows-x86_64:4.1.7")
        implementation("com.caoccao.javet:javet-node-windows-x86_64-i18n:4.1.7")
        implementation("com.caoccao.javet:javet-v8-linux-arm64:4.1.7")
        implementation("com.caoccao.javet:javet-v8-linux-arm64-i18n:4.1.7")
        implementation("com.caoccao.javet:javet-v8-linux-x86_64:4.1.7")
        implementation("com.caoccao.javet:javet-v8-linux-x86_64-i18n:4.1.7")
        implementation("com.caoccao.javet:javet-v8-macos-arm64:4.1.7")
        implementation("com.caoccao.javet:javet-v8-macos-arm64-i18n:4.1.7")
        implementation("com.caoccao.javet:javet-v8-macos-x86_64:4.1.7")
        implementation("com.caoccao.javet:javet-v8-macos-x86_64-i18n:4.1.7")
        implementation("com.caoccao.javet:javet-v8-windows-x86_64:4.1.7")
        implementation("com.caoccao.javet:javet-v8-windows-x86_64-i18n:4.1.7")
...
.. tab:: Complete
    ...
    .. code-block:: kotlin
        ...
        implementation("com.caoccao.javet:javet-$jsRuntimeTimeType-$osType-$archType$i18nType:4.1.7")
...
.. code-block:: kotlin
    ...
    implementation("com.caoccao.javet:javet-node-android:4.1.7") // Android Node (arm64 and x86_64)
    implementation("com.caoccao.javet:javet-node-android-i18n:4.1.7") // Android Node (arm64 and x86_64)
    implementation("com.caoccao.javet:javet-v8-android:4.1.7") // Android V8 (arm, arm64, x86 and x86_64)
    implementation("com.caoccao.javet:javet-v8-android-i18n:4.1.7") // Android V8 (arm, arm64, x86 and x86_64)
