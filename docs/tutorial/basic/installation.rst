...
.. code-block:: kotlin
    ...
    implementation("com.caoccao.javet:javet:1.0.8") // Linux and Windows (x86_64)
    implementation("com.caoccao.javet:javet-macos:1.0.8") // Mac OS (x86_64 and arm64)
    implementation("com.caoccao.javet:javet-android:1.0.8") // Android (arm, arm64, x86 and x86_64)
