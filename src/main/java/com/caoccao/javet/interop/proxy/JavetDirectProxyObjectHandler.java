    ...
    public JavetCallbackContext[] getCallbackContexts() {
        return new JavetCallbackContext[]{
                new JavetCallbackContext(
                        ...
                        (IJavetDirectCallable.NoThisAndResult<E>) (v8Values) -> get(v8Values[0], v8Values[1], v8Values[2])),
                new JavetCallbackContext(
                        PROXY_FUNCTION_NAME_HAS, this,
                        (IJavetDirectCallable.NoThisAndResult<E>) (v8Values) -> has(v8Values[0], v8Values[1])),
                new JavetCallbackContext(
                        PROXY_FUNCTION_NAME_OWN_KEYS, this,
                        (IJavetDirectCallable.NoThisAndResult<E>) (v8Values) -> ownKeys(v8Values[0])),
                new JavetCallbackContext(
                        PROXY_FUNCTION_NAME_SET, this,
                        (IJavetDirectCallable.NoThisAndResult<E>) (v8Values) -> set(v8Values[0], v8Values[1], v8Values[2], v8Values[3])),
        };
    }
