...
/**
 * The type V8 value sealed array.
 *
 * @since 3.1.3
 */
@SuppressWarnings("unchecked")
public class V8ValueSealedArray extends V8ValueObject implements IV8ValueSealedArray {
    ...
    V8ValueSealedArray(V8Runtime v8Runtime, long handle) throws JavetException {
