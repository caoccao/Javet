...
# Usage: docker build \
#  -t sjtucaocao/javet:x86_64-v8_10.8.168.20-node_18.12.1 \
...
FROM ${JAVET_REPO}:x86_64-base-v8_${JAVET_V8_VERSION} as base-v8
...
FROM ${JAVET_REPO}:x86_64-base-node_${JAVET_NODE_VERSION} as base-node
