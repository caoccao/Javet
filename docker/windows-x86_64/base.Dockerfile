...
# Usage: docker build -t sjtucaocao/javet-windows:4.1.7 -m 4G -f docker/windows-x86_64/base.Dockerfile .

ARG JAVET_NODE_VERSION=22.19.0
ARG JAVET_V8_VERSION=13.9.205.19
