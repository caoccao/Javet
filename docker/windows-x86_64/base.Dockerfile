...
# Usage: docker build -t sjtucaocao/javet-windows:5.0.2 -m 4G -f docker/windows-x86_64/base.Dockerfile .

ARG JAVET_NODE_VERSION=24.10.0
ARG JAVET_V8_VERSION=14.2.231.5
