...
# Usage: docker build -t sjtucaocao/javet-windows-x86_64:5.0.5 -m 8G -f docker/windows-x86_64/build.Dockerfile .

# Multi-stage Dockerfile for building Javet on Windows x86_64
# Based on .github/workflows/windows_x86_64_build.yml

# Build arguments
ARG JAVET_NODE_VERSION=24.14.0
ARG JAVET_V8_VERSION=14.6.202.8
ARG JAVET_VERSION=5.0.5
